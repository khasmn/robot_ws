...
: ${AMENT_CURRENT_PREFIX:="/home/kha/robot_ws/install/gantry_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gantry_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gantry_moveit_config/environment/path.sh"
